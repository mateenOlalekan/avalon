...
const CategorySidebar = () => {
  ...
  const categories = [
    { icon: ShoppingBag, name: "Appliances", id: "appliances", path: "/appliances" },
    { icon: Smartphone, name: "Phones & Tablets", id: "phones", path: "/phones-tablets" },
    { icon: Sparkles, name: "Health & Beauty", id: "health", path: "/health-beauty" },
    { icon: Home, name: "Home & Office", id: "home", path: "/home-office" },
